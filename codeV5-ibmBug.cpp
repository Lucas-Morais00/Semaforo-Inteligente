...
void loop() {
  ...
  if (contador < 5){
    ...
    contador = 0;
    tempoSemaforo(14000, 2000, 14000);
    
    }else if (contador >= 5 && contador < 10){
      
      contador = 0;      
      tempoSemaforo(18000, 2000, 10000);

      
    }else if (contador >= 10){
      
      contador = 0;
      tempoSemaforo (2200, 2000, 4000);
...
Mudar visualização estadoSemaforo
Decidir valores de distancia e contagem de carros
Mudar credenciais do WIFI
...
/*Funcionamento do semáforo: A partir do tempo base do semáforo, incrementar 1 segundo a cada X carros que passarem.*/
